...
public class MonkeyDropWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(MonkeyDropWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/MonkeyDropIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/MonkeyDropIW/InitOutcome.xml").getDocumentElement();
